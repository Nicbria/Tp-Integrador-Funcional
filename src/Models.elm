...
toyStory3 : Movie
toyStory3 = {id= 2, poster= createPoster "./Assets/Toy_Story_3_poster.png", title= "Toy Story 3", rating= 9.0, genre= ["Family", "Animated","animada"], link= "https://www.youtube.com/watch?v=JcpWXaA2qeg", likes = 0, matchPercentage = 0, forKids = True, actors = ["Tom Hanks", "Tim Allen", "Don Rickles", "Wallace Shawn", "John Ratzenberger", "Ned Beatty", "Michael Keaton", "John Morris", "Blake Clark"]}

lionKing : Movie
lionKing = {id= 3, poster= createPoster "./Assets/The_Lion_King.png", title= "Lion King", rating= 9.5, genre= ["Family", "Animated","animada"], link= "https://www.youtube.com/watch?v=_ujGv5dhGfk", likes = 0, matchPercentage = 0, forKids = True, actors = ["Rowan Atkinson", "Matthew Broderick", "Niketa Calame-Harris", "Jeremy Irons", "James Earl Jones", "Nathan Lane", "Ernie Sabella"]}

it : Movie
it = {id= 4, poster= createPoster "./Assets/it_poster.png", title= "IT", rating= 8.0, genre= ["Horror","terror"], link= "https://www.youtube.com/watch?v=hAUTdjf9rko", likes = 0, matchPercentage = 0, forKids = False, actors = ["Jaeden Lieberher", "Bill Skarsgård", "Wyatt Oleff", "Jeremy Ray Taylor", "Sophia Lillis", "Finn Wolfhard"]}
